...
<form:form name="addForm" commandName="empdto" method="POST" action="${pageContext.request.contextPath}/add.form">
	<table align="center" >
	<tr> <td align="right">Employee ID : </td>
		<td><form:input id="empid" path="id" readonly="true" cssStyle="border-radius: 5px;" value="${empdto.id}"/></td>
	</tr>
	<tr> <td align="right">Employee Name: </td>
		<td><form:input id="name" path="name" cssStyle="border-radius: 5px;" value="${empdto.name}"/></td>
	</tr>
	...
	<tr> <td align="right">Employee Salary: </td>
		<td><form:input id="salary" path="salary" cssStyle="border-radius: 5px;" value="${empdto.salary}"/></td>
	</tr>
	<tr align="right"><td> </td> <td><form:errors path="salary" cssStyle="color: #ff0000;" /></td></tr>
		
	<tr> <td align="right">Employee Address: </td>
		<td><form:input id="address" path="address" cssStyle="border-radius: 5px;" value="${empdto.address}"/></td>
	</tr>	
